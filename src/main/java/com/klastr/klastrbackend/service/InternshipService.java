...
public interface InternshipService {
        ...
        // ATTENDANCE
        void registerAttendance(UUID tenantId, UUID internshipId, RegisterAttendanceRequest request);

        void submitWeek(UUID tenantId, UUID internshipId, UUID weekId);

        void approveWeek(UUID tenantId, UUID internshipId, UUID weekId);

        void rejectWeek(UUID tenantId, UUID internshipId, UUID weekId, String reason);
